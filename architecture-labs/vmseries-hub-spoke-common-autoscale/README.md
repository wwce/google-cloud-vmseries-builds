/google-cloud-vmseries-builds
  /labs
    /autoscale-vmseries-common
    /autoscale-vmseries-inbound
    /autoscale-vmseries-outbound
    /multi-nic-vmseries-common
    /hub-spoke-vmseries-common
    /hub-spoke-vmseries-distributed
    /ilbnh-with-network-tags
  /blueprints
  /modules
    /vmseries_instance_group_unmanaged
    /vmseries_instance_group_managed
    /bootstrap_bucket
    /quick_vpc
